...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '- Predictive Maintenance: AI models can predict hardware failures before they happen by analysing usage patterns and system metrics.\n- Intelligent Monitoring: Instead of manually reviewing logs, AI-powered tools surface anomalies automatically.\n- Automated IT Support: Chatbots and language models are handling Tier-1 helpdesk queries, reducing response time dramatically.\n- Security: AI is used in threat detection — identifying abnormal behaviour in network traffic in real time.',
  ...
  },
  {
    ...
    content: [
      ...
      '**The Stack**',
      '- Framework: Next.js (Pages Router) with TypeScript for type safety\n- Styling: Tailwind CSS v4 with a custom Red and White design system\n- Animation: Framer Motion for smooth page transitions and scroll reveals\n- Deployment: Vercel — zero-configuration, automatic deployments from GitHub',
      '**Challenges I Encountered**',
      '- ESM vs CommonJS: Migrating to ES Modules required updating all config files to use the export default syntax.\n- Tailwind v4 Breaking Changes: The new @theme directive replaced the old tailwind.config.js approach.\n- Open Graph Meta Tags: Getting WhatsApp and social previews to show the correct image and title required careful management of Head meta tags.',
      '**Key Lessons**',
      'Start with mobile-first design — it is much harder to make a desktop design responsive than the reverse. Performance is a feature. Accessibility matters — high-contrast text, keyboard navigation, and meaningful alt tags are not optional.',
